...
Таблица "tmp_26" - снэпшоты с видеокамер, привязаные к датчикам или другим событиям. Заполнеются отдельным скриптом.
...
Некоторые поля новых sql-таблиц дублируют данные из таблицы tCont - это плохой стиль sql, но сделано умышленно чтобы не трогать "родные" таблицы для гарантированной работоспособности  web-клиентов и беспроблемного апгрейда на новые версии ab-log demo.
